...
def recognizeComicTextureFormat(texPathList, texFormatList):
    ...
    if texFormat == "IG_GFX_TEXTURE_FORMAT_X_8 (65536)":
        ...
        questions.printError("This model uses a png texture that's uncompressed with an alpha channel (plain png texture). This texture format is not supported by igbFinisher. Please choose a different texture.", False)
...
def getComicTextureFormat(settings, fullFileName):
    ...
    if len(texPathList) == 0:
        ...
        (png8Counter, dxt1Counter, texFolder, texFile) = recognizeComicTextureFormat(texPathList, texFormatList)
        # Get the file name
        ...
        if png8Counter == 1:
            ...
            if settings["pcOnly"] == False:
                ...
                textureFolderList = ["XML1 PS2", "XML2 PS2", "XML2 PSP", "MUA1 PS2 and PSP"]
            else:
            ...
            if settings["pcOnly"] == False:
                ...
                textureFolderList = ["XML1 Xbox", "XML1 GC", "XML2 PC and Xbox", "XML2 GC", "MUA1 Next-Gen", "MUA1 Wii and Xbox"]
            else:
                # The model is being process for PC only.
        ...
        questions.printError("Two or more textures were found in the model. Loading screens should only have one texture applied. Please try again.", False)

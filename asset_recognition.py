...
def assetRecognition(inputFileName, fullFileName, settings):
    ...
    fileNameList = ["igActor01_Animation01DB.igb", "123XX (Mannequin", "123XX (3D Head).igb", "hud_head_123XX.igb", "123XX (Character Select Portrait).igb", "123XX (Loading Screen).igb", "power_icons.igb", "comic_cov.igb"]
    # Create the list of asset types
    assetTypeList = ["Skin", "Mannequin", "3D Head", "Conversation Portrait", "Character Select Portrait", "Loading Screen", "Power Icons", "Comic Cover"]

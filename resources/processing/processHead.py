...
def headProcessing(fullFileName, settings, XMLPath, MUAPath):
    ...
    if not(textureFormat == None):
        ...
        XML1Name = resources.setUpFileName(fullFileName, "", settings["XML1Num"], "XX (3D Head).igb")
        XML2Name = resources.setUpFileName(fullFileName, "", settings["XML2Num"], "XX (3D Head).igb")
        MUA1Name = None
        MUA2Name = None
        # Copy the files

    ...
    if len(texPathList) == 0:
        ...
        if plainPngCounter == 1:
            ...
            if texFile[0:3] == "ng_":
                ...
                questions.PrintError("The texture name does not have the \"ng_\" prefix, but the texture format was detected as plain png. This means that the texture was not exported correctly. Please try again.")

...
def recognizeCSPTextureFormat(texPathList, texFormatList):
    ...
    if texFormat == "IG_GFX_TEXTURE_FORMAT_X_8 (65536)":
        ...
        questions.PrintError("This model uses a plain png texture. This texture format is not supported with CSPs. Please choose a different texture.")
    ...
    if len(texPathList) == 0:
        ...
        if ((png8Counter == 1) or (dxt1Counter == 1)):
            ...
            if texFile[0:4] == "x1c_":
                ...
                questions.PrintError("The texture name does not have the correct prefix. This means that the texture was not exported correctly. Please try again.")
        ...
        questions.PrintError("Two or more textures were found in the model. HUDs should only have one texture applied. Please try again.")
